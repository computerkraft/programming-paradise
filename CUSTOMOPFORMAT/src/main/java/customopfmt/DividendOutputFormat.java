...
import customopfmt.DividendJob.DividendChange;
...
public class DividendOutputFormat extends FileOutputFormat<NullWritable, DividendChange> {
	...
	public static class DividendRecordWriter extends RecordWriter<NullWritable, DividendChange> {
		...
		public void write(NullWritable key, DividendChange value)
			...
			result.append(value.getSymbol()).append(SEPARATOR).append(value.getDate()).append(SEPARATOR).append(value.getChange()).append('\n');
	...
	@Override
	public RecordWriter<NullWritable, DividendChange> getRecordWriter(TaskAttemptContext context)
			throws IOException, InterruptedException {
